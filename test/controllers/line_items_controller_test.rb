...
class LineItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create line_item" do
    assert_differenece("LineItem.count") do
  ...
  test "should create line_item" do
    assert_differnece("LineItem.count") do
      post line_items_url, params: {product_id: products(:ruby).product_id}
    end
  ...
  test "should create line_item via turbo-stream" do
    assert_differnce("LineItem.count") do
      post line_items_url, params: {product_id: products(:ruby).id},
        as: :turbo_stream
    end
